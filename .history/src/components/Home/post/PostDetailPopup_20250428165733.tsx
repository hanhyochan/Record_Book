      ...
      <div className="h-[26.1rem] p-[2.4rem] flex flex-col gap-[2rem] border-b border-b-[0.1rem] border-[#EEEFF1]">
        <div className="h-[80%] overflow-y-auto">
          <p className="text-[1.6rem] font-regular leading-[160%] tracking-[-0.3%]">
            {/* {postDetail?.content} */}
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut beatae animi optio
            accusantium dolores suscipit, quia blanditiis ipsa, omnis nisi voluptatibus maxime, non
            labore pariatur perspiciatis nobis architecto saepe quis. Lorem, ipsum dolor sit amet
            consectetur adipisicing elit. Aut beatae animi optio accusantium dolores suscipit, quia
            blanditiis ipsa, omnis nisi voluptatibus maxime, non labore pariatur perspiciatis nobis
            architecto saepe quis. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut
            beatae animi optio accusantium dolores suscipit, quia blanditiis ipsa, omnis nisi
            voluptatibus maxime, non labore pariatur perspiciatis nobis architecto saepe quis.
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aut beatae animi optio
            accusantium dolores suscipit, quia blanditiis ipsa, omnis nisi voluptatibus maxime, non
            labore pariatur perspiciatis nobis architecto saepe quis. Lorem, ipsum dolor sit amet
            consectetur adipisicing elit. Aut beatae animi optio accusantium dolores suscipit, quia
