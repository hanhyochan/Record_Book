          ...
          {postListContents.map(post => (
            ...
            >
              <div className="flex flex-col gap-[1rem]">
                <p className="text-[1.6rem] font-bold leading-[160%] tracking-[-0.3%]">예시</p>
                <div className="flex gap-[1.3rem]">
                  <p className="text-[1.4rem] font-regular text-[#A7A9B4]">예시</p>
                  <div className="flex gap-[0.5rem]">
                    <img src="/icon/Comments.svg" alt="댓글아이콘" width="20" height="20" />
                    <p className="text-[1.4rem] font-regular text-[#A7A9B4]">1</p>
                  </div>
                </div>
              </div>
              <div>
                <div className="flex w-[2.7rem] h-[2.7rem] bg-[#A7A9B4] rounded-[50rem]"></div>
                <p className="font-bold text-[1.6rem] leading-[150%] tracking-[-0.3%]">
                  멋진무지개
                </p>
              </div>
            </div>
