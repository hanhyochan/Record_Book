  ...
  return (
    <div className="w-[100%] h-[100%] flex flex-col bg-white border-[0.1rem] border-[#EEEFF1] rounded-[1.2rem]">
      ...
      <div className="h-[26.1rem] p-[2.4rem] flex flex-col justify-between gap-[2rem] border-b border-b-[0.1rem] border-[#EEEFF1]">
        ...
        <div class="w-full max-w-2xl mx-auto p-4 bg-green-50 border border-gray-200 rounded-md">
          <div class="flex items-center mb-2">
            <div class="w-6 h-6 bg-gray-300 rounded-full mr-2"></div>
            <span class="text-sm font-semibold text-gray-700">향기는영원하리123</span>
          </div>
          ...
          <div class="text-xs text-gray-400 mb-4">24.06.12</div>
          <div class="flex items-center gap-2">
            <input
              type="text"
              placeholder="댓글을 통해 자유롭게 의견을 나눠보세요"
              class="flex-1 p-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-200"
            />
            <button class="px-4 py-2 bg-black text-white text-sm rounded-md hover:bg-gray-800">
              등록
            </button>
          </div>
        </div>
