...
interface UiStateProps {
  ...
  // 게시글 상세 데이터
  postDetailContents: postDetailType | null;
  setPostDetailContents: (data: postDetailType) => void;
}
...
const useUiState = create<UiStateProps>(set => ({
  ...
  setPostDetailContents: (data: postDetailType) => set({ postDetailContents: data }),
}));
